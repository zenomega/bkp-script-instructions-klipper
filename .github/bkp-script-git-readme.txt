...
In the version prior to this only a default install of klipper was supported. Now you can use this script with systems that were set up with KIAUH too and it even supports multiple instances of klipper!
